...
class WarpMetric:
    ...
    # ============================================================
    # МЕТОДИ ЗА СЕТ 05 - THIN-SHELL СПЕЦИФИЧНИ
    # ============================================================
    
    def metric_on_shell(self, theta, phi, r=None):
        """Метрика върху обвивката (сферични координати)"""
        if r is None:
            r = self.params['R0']
    ...
    def shell_stability(self, x, y, z):
        """Проверка на стабилността на обвивката"""
        Sxx = self.Sxx(x, y, z)
        Syy = self.Syy(x, y, z)
        Szz = self.Szz(x, y, z)
...
# ============================================================
# ПРОВЕРКИ 121-140: THIN-SHELL И ISRAEL JUNCTION CONDITIONS
# ============================================================
...
class ThinShellChecks:
        ...
        for r in results:
            ...
            for key, value in r.items():
                if isinstance(value, (bool, np.bool_)):
                    ...
                    # Рекурсивно подготвяне на вложени речници
                    sub_item = {}
    ...
    def check_121_124_metric_continuity(self):
        """Проверки 121-124: Непрекъснатост на метриката върху обвивката Σ"""
        test_points = [
            (0, np.pi/2, "екватор"),
        ...
        for i, (theta, phi, name) in enumerate(test_points, 121):
            ...
            # защото g_tt е различно (вътре -1, външно warp)
            ...
            # Очакваме пространствените компоненти да съвпадат
    ...
    def check_125_128_extrinsic_K_plus(self):
        """Проверки 125-128: Външна кривина K_ij^+ от външната страна"""
        test_points = [
    ...
    def check_129_132_extrinsic_K_minus(self):
        """Проверки 129-132: Вътрешна кривина K_ij^- от вътрешната страна"""
        test_points = [
    ...
    def check_133_136_jump_condition(self):
        """Проверки 133-136: Скачок на външната кривина [K_ij] = K_ij^+ - K_ij^-"""
        test_points = [
            (1.95, 0, 0, "вътрешен край на стената"),
            (2.0, 0, 0, "стена"),
            (2.05, 0, 0, "външен край на стената"),
    ...
    def check_137_140_shell_stability(self):
        """Проверки 137-140: Стабилност на обвивката срещу колапс или разширение"""
        test_points = [
...
def main():
    ...
    print("="*70)
    print("WARP BUBBLE CHECKS - SET 05 (Проверки 121-140)")
    print("Thin-Shell и Israel junction conditions")
    print("="*70)
    print()
    ...
    filename = f"checks_set05_{timestamp}.json"
    ...
    report = {
        ...
        'set': "05",
        'checks': "121-140",
        'description': "Thin-Shell and Israel junction conditions",
        'total': len(results),
        'passed': passed,
        'failed': failed,
